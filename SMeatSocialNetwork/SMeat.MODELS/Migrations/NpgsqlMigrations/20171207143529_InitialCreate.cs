        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthdate = table.Column<DateTimeOffset>(type: "timestamptz", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "text", nullable: true),
                    CustomGenderType = table.Column<string>(type: "text", nullable: true),
                    Email = table.Column<string>(type: "varchar(256)", maxLength: 256, nullable: true),
                    EmailConfirmed = table.Column<bool>(type: "bool", nullable: false),
                    GenderType = table.Column<int>(type: "int4", nullable: false),
                    ...
                    RelationshipType = table.Column<int>(type: "int4", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRole = table.Column<int>(type: "int4", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTime = table.Column<DateTimeOffset>(type: "timestamptz", nullable: true),
                    GroupChatId = table.Column<string>(type: "text", nullable: true),
                    MessageStatus = table.Column<int>(type: "int4", nullable: false),
                    Text = table.Column<string>(type: "text", nullable: true),
                    UserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Permitions = table.Column<int>(type: "int4", nullable: false)
                },
                constraints: table =>
                {
