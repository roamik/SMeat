...
namespace SMeat.DAL.Abstract
{
  public interface IContactsRepository : IGenericRepository<Friends>
  {
    ...
    Task<List<Friends>> GetPagedContactsAsync(List<Expression<Func<Friends, bool>>> filters = null, int count = 10, int page = 0, params Expression<Func<Friends, object>>[] includes);
  }
}